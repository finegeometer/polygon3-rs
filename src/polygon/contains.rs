...
fn test_square() {
    ...
    let square: Polygon = ConvexPolygon::from_boundaries(boundaries.into_iter())
        .unwrap()
        .try_into()
        .unwrap();
...
fn test_diamond() {
    ...
    let diamond: Polygon = ConvexPolygon::from_boundaries(boundaries.into_iter())
        .unwrap()
        .try_into()
        .unwrap();
